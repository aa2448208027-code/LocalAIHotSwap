...
Future work should add tokenizer-aware budgeting through a backend adapter. That
belongs in a separate branch because it touches model metadata, request shaping,
and testing.
